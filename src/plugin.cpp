...
// // Function to set the description of a TESDescription-having form (like SpellItem)
// void SetFormDescription(RE::TESDescription* descHolder, const char* newDescriptionText) {
//     if (!descHolder) {
//         return;
//     }

//     // The member to change is 'descriptionText' of type BGSLocalizedStringDL
//     // BGSLocalizedStringDL can be assigned a const char* directly.
//     // This will store the string directly in the object, not as a string table ID.
//     descHolder->descriptionText = newDescriptionText;
// }
